...
from einfochips.core.cli_parser import einfochipsArgumentParser
from einfochips.core.console import set_logger_configuration, print_info, print_exception
from einfochips.core.exceptions import RuleExceptions
from einfochips.core.processingengine import ProcessingEngine
from einfochips.core.ruleset import Ruleset
from einfochips.core.server import Server
from einfochips.output.html import einfoReport
from einfochips.output.utils import get_filename
from einfochips.providers import get_provider
from einfochips.providers.base.authentication_strategy_factory import get_authentication_strategy


def run_from_cli():
    parser = einfochipsArgumentParser()
...
def run(provider,
    ...
    """
    Run a einfo job in an async event loop.
    """
...
async def _run(provider,
    ...
    try:
        ...
        report = einfoReport(cloud_provider.provider_code,
                             report_name,
                             report_dir,
                             timestamp,
