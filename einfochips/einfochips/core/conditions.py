...
from einfochips.core.console import print_error, print_exception
...
def pass_conditions(all_info, current_path, conditions, unknown_as_pass_condition=False):
    ...
    from einfochips.providers.base.configs.browser import get_value_at
...
def pass_condition(b, test, a):
    """
    Generic test function used by einfo
                                        .
