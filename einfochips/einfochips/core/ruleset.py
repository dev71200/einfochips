...
from einfochips.core.console import print_debug, print_error, prompt_yes_no, print_exception

from einfochips.core.rule import Rule
from einfochips.core.rule_definition import RuleDefinition
...
class Ruleset:
    ...
    def find_file(self, filename, filetype='rulesets'):
        ...
        if filename and not os.path.isfile(filename):
            # Not a valid relative / absolute path, check einfo's data under findings/ or filters/
