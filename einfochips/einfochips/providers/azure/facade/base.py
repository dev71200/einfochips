...
from einfochips.providers.azure.facade.aad import AADFacade
from einfochips.providers.azure.facade.rbac import RBACFacade
from einfochips.providers.azure.facade.keyvault import KeyVaultFacade
from einfochips.providers.azure.facade.network import NetworkFacade
from einfochips.providers.azure.facade.resourcemanagement import ResourceManagementFacade
from einfochips.providers.azure.facade.securitycenter import SecurityCenterFacade
from einfochips.providers.azure.facade.sqldatabase import SQLDatabaseFacade
from einfochips.providers.azure.facade.storageaccounts import StorageAccountsFacade
from einfochips.providers.azure.facade.virtualmachines import VirtualMachineFacade
from einfochips.providers.azure.facade.appservice import AppServiceFacade
from einfochips.providers.azure.facade.mysqldatabase import MySQLDatabaseFacade
from einfochips.providers.azure.facade.postgresqldatabse import PostgreSQLDatabaseFacade
from einfochips.providers.azure.facade.loggingmonitoring import LoggingMonitoringFacade

from azure.mgmt.resource import SubscriptionClient
from einfochips.providers.base.authentication_strategy import AuthenticationException
from einfochips.utils import get_user_agent

from einfochips.core.console import print_info, print_exception

# Try to import proprietary services
try:
    from einfochips.providers.azure.facade.appgateway_private import AppGatewayFacade
except ImportError:
    pass
try:
    from einfochips.providers.azure.facade.loadbalancer_private import LoadBalancerFacade
except ImportError:
    pass
try:
    from einfochips.providers.azure.facade.rediscache_private import RedisCacheFacade
except ImportError:
    pass
