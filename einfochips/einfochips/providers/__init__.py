...
def get_provider_object(provider):
    ...
    provider_module = __import__(f'einfochips.providers.{provider}.provider', fromlist=[provider_class])
...
def get_provider(provider,
    ...
    :param services:            Exclusive list of services on which to run einfo chips
    :param skipped_services:    List of services not to run einfo chips on
