...
from einfochips.core.console import print_exception, print_debug, print_warning
...
from einfochips.providers.utils import run_concurrently, get_and_set_concurrently
...
class S3Facade(AWSBaseFacade):
    async def get_buckets(self):
        try:
            ...
            # as per https://github.com/eicgroup/einfochips/issues/727
            buckets = []
            exception = None
            ...
            for region in region_list:
                try:
                    ...
                    exception = None  # Fix for https://github.com/eicgroup/einfochips/issues/916#issuecomment-728783965
                    break
            if not buckets:
                if exception:
    ...
    def _get_and_set_s3_bucket_creationdate(self, buckets):
        ...
        # Fixes issue https://github.com/eicgroup/einfochips/issues/858
