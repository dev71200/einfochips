...
class TestAzureProviderClass(unittest.TestCase):
    @mock.patch("einfochips.providers.azure.authentication_strategy.UsernamePasswordCredential")
    ...
    @mock.patch("einfochips.providers.azure.authentication_strategy.AzureCliCredential")
