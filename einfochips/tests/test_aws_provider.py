...
from einfochips.providers.aws.authentication_strategy import AWSCredentials
...
class TestAWSProviderClass(unittest.TestCase):
    @mock.patch("einfochips.providers.aws.authentication_strategy.boto3")
    @mock.patch("einfochips.providers.aws.authentication_strategy.get_caller_identity")
    ...
    @mock.patch("einfochips.providers.aws.facade.base.get_aws_account_id")
    @mock.patch("einfochips.providers.aws.facade.base.get_partition_name")
    @mock.patch("einfochips.providers.aws.provider.get_aws_account_id")
    @mock.patch("einfochips.providers.aws.provider.get_partition_name")
