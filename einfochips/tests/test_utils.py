# Import AWS utils
from einfochips.providers.aws.utils import (
    get_keys,
    no_camel,
    get_name,
    is_throttled,
...
#
# Test methods for einfochips/utils.py
#
class TesteinfoUtilsClass(unittest.TestCase):
    ...
    def test_get_identity(self):
        with mock.patch(
            "einfochips.providers.aws.utils.get_caller_identity",
