...
from einfochips.core.console import set_logger_configuration, print_error
...
class TesteinfoRulesProcessingEngine(unittest.TestCase):
    ...
    def test_all_finding_rules(self):
        ...
        with open(os.path.join(self.test_dir, '../einfochips/providers/aws/rules/rulesets/default.json'), 'rt') as f:
            ruleset = json.load(f)
